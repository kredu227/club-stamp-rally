...
const activities = [
  ...
  },
  {
    "name": "그루터기",
    "location": "도서관",
    "description": "폐도서와 탄소중립을 접목시킨 창의적 사고 활동",
    "detail": "[1] 책 표지 퍼즐\n  ? 폐도서 표지의 원래의 모습을 찾아주는 게임!\n[2] 폐도서 사격\n  ? 폐도서를 활 혹은 총으로 쓰러뜨리는 게임!\n  ? 쓰러뜨린 폐도서가...상품...!!\n[3] 피지컬 퀴즈 (겁나 어려움 + 가장 좋은 보상)\n  ? 답을 맞추려면 정답이 있는 페트병에 공을 넣어야함\n  ? 퀴즈의 정답을 알아도 답을 못맞출 수 있다???\n  ? 정답을 맞추면 맛있는 간식\n[4] 마그넷 캔뱃지\n  ?활동에 열심히 참여하면 마그넷 캔뱃지 증정!\n  ? 내가 아끼는 사진은 캔뱃지로!"
  },
  {
    "name": "글로벌리더십",
    "location": "2-1",
  ...
  },
  {
    "name": "정치언론부",
    "location": "1-2",
    "description": "포장마차 테마 부스 '취중정치'",
    "detail": "취중정치'는 동아리 이데아에서 운영하는 학생 주도형 시사 퀴즈와 영화 시청 및 다트 게임, 외교 전략 게임과 같은 다양한 체험이 마련되어 있는 포장마차 테마의 부스이며, 이상적인 즐거움의 공간입니다. 입장 시 시사 퀴즈에 참여하여 승리하면 원하는 음료를 제공해드립니다. 이밖에 다트와 같은 미니게임에 참여하여 추가적인 음료와 간식이 주어집니다. 전략과 판단, 지성과 힐링을 모두 경험할 수 있는 꿈의 공간입니다.\n+ 친구들과 함께 오는 것을 권장합니다.\n(위 3가지 체험 모두 이용 시 스탬프 제공)"
  },
  {
    "name": "축구부",
    "location": "1-5,운동장",
