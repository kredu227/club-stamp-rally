...
const clubs = [
  // 본관 그룹
  { id: 'club1', name: '글로벌리더십', location: '본관', qrCode: '9pm6lm2o' },
  { id: 'club2', name: '그대의말로', location: '본관', qrCode: 'tsj5d5m3' },
  { id: 'club3', name: '레드타이', location: '본관', qrCode: '81m0yjoh' },
  { id: 'club4', name: 'mRNA', location: '본관', qrCode: 'ei3a03yc' },
  { id: 'club5', name: '나라사랑', location: '본관', qrCode: '6r4kdqu4' },
  { id: 'club6', name: '방송부', location: '본관', qrCode: '0rfvy83d' },
  { id: 'club7', name: '농구부', location: '본관', qrCode: '15jn9ypy' },
  { id: 'club8', name: '또래상담', location: '본관', qrCode: 't587ywmv' },
  { id: 'club9', name: '독수공방', location: '본관', qrCode: 'n9zo15xk' },
  { id: 'club10', name: '아크매틱', location: '본관', qrCode: 't2pax9w4' },
  { id: 'club11', name: '개척', location: '본관', qrCode: 'ddjg5k41' },
  { id: 'club12', name: '국과수', location: '본관', qrCode: 'ppm904xl' },
  { id: 'club13', name: '가피', location: '본관', qrCode: '54sknfs2' },
  { id: 'club14', name: '에코', location: '본관', qrCode: 'pb26er6s' },
  { id: 'club15', name: '여가활용부', location: '본관', qrCode: 'k378ueoi' },
  // 후관 그룹
  { id: 'club16', name: '생각의판', location: '후관', qrCode: 'eolu137q' },
  { id: 'club17', name: '정치언론부', location: '후관', qrCode: 'n1dvx1n4' },
  { id: 'club18', name: '대중문화탐구', location: '후관', qrCode: '1vz84gam' },
  { id: 'club19', name: '내꿈찾아삼만리', location: '후관', qrCode: '0b4shc8g' },
  { id: 'club20', name: '축구부', location: '후관', qrCode: 'g5yk0xa7' },
  { id: 'club21', name: '역사랑', location: '후관', qrCode: '3c0ds7tg' },
  { id: 'club22', name: '화생방', location: '후관', qrCode: 'pu7yd54j' },
  { id: 'club23', name: 'BIOHOLIC', location: '후관', qrCode: 'd8oob63w' },
  { id: 'club24', name: '아이러닝', location: '후관', qrCode: 's80ci3yk' },
  { id: 'club25', name: '그루터기', location: '후관', qrCode: 'j5fn8uu4' },
];
